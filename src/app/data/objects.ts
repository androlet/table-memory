...
export const OBJECTS = [
  ...
  'poudre', 'truffe', 'vélo', 'étoile', 'sucre', 'porte-manteau', 'ordinateur', 'bouchon d\'oreille', 'clef', 'dent',
  'moineau', 'moine', 'tatouage', 'vis', 'passeport', 'ragoût', 'mouchoir', 'jardin', 'ballon', 'veine',
  'coeur', 'papier', 'cheminée', 'tableau', 'casserole', 'perruque', 'quille', 'huitre', 'oeuf', 'AWS'
];
